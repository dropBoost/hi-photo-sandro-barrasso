...
import { createEventAction } from "@/app/manager/event/create-event/action/createEvent.action";
...
export default function COMPcreateEvent() {
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Compila i campi e crea una nuova raccolta per un evento.</CardDescription>
      </CardHeader>
